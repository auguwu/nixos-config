...
in {
  users.users.noel = {
    ...
    openssh.authorizedKeys.keys = [
      ...
      # Workstation (new: noel@floofbox)
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOWTaisb+qev/PBaZQHO/41seP4KOoAWfwCGDUriMdfO noel@floofbox"

      # Workstation (old: noel@floofbox)
